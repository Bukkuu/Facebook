...
def submit():
    ...
    c = conn.cursor()
    c.execute('''insert into user values(:firstName, :lastName,:age,:adress,:city,:Zipcode,:password,:gender)''',
              {'firstName': firstname.get(), 'lastName': lastname.get(), 'age': age.get(), 'adress': address.get(),
